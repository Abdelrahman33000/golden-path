...
const Product1 = () => {
  return (
    <>
            <h1 className='project bg-dark text-light text-center p-5' style={{fontFamily:"Bodoni Moda"}}> product Details</h1>
...
<div className="m-3">
              ...
              >
                <button className="btn5 p-3 my-3 rounded-4 w-100">Request Now</button>
              </div>
            </form>
          </div>
