...
const About = () => {
  return (
    <div>
      ...
      <div
        className="d-flex justify-content-around my-5 text-left"
      ...
      >
        ...
        <div className="col-lg-5 py-3 " style={{ textAlign: "justify" }}>
          ...
          <p>
            ...
            quae repellendus ea! Explicabo nemo a quisquam error molestiae,
            reiciendis tempora veniam molestias voluptatem, magni est numquam
            quibusdam deserunt sapiente cumque?
          </p>
          <div className="">
            <p>
