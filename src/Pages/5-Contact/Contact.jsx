    ...
    <div className="container-fluide  mt-0">
      ...
      <div className="container-fluide side rounded-5   mt-5 ">
        ...
        <Lottie animationData={contact}   />
            ...
            <h6 className="mx-4 mb-4">{t('Simply leave your contact number, We will call you back.')}
          ...
          <div className="container-fluide  my-5 mx-2 shadow-lg   rounded-4 mt-2 col-lg-8">
            <form action={"#"} className="contact ">
              <div className="d-flex justify-content-around mt-5  ">
                <div className="mx-1 form-control">
                  <div>
              ...
              <div className="d-flex mx-1  justify-content-around my-5">
                <div className="mx-1 form-control ">
                  <div>
                    <label>{t('Phone Number')}</label>
                  </div>
                  <input type="number" className="inp mt-3" required />
                </div>
                <div className=" mx-1 form-control">
                  <div>
...
<div className="mx-3">
              ...
              <textarea placeholder={t('Message...')} className="form-control rounded-5  p-4  w-100" style={{backgroundColor:"#b4b4ad" }} required></textarea>
              </div>
              ...
              >
                <button className="btn5 p-3 rounded-4 w-100">{t('Submit')}</button>
              </div>
            </form>
          </div>
...
<iframe title="Egypt" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7075996.015790168!2d24.49644870755294!3d30.005968900000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14585721b6b5448d%3A0x808c7d87826a88a7!2sNewYorker!5e0!3m2!1sen!2seg!4v1703787357411!5m2!1sen!2seg"  height="450" style={{width:"100vw" , border:"2px solid #000"}}  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  );
};
